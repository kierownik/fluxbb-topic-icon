...
'options'                                 =>  'Options',
'icons in a row'                          =>  'How many icons do you want in a row?',
'icons in a row info'                     =>  '0 will disable this and put everything on one line',
'name'                                    =>  'Name',
...
'forgot something'                        =>  'you forgot something, go back and correct it.',
'actions'                                 =>  'Actions',
'edit'                                    =>  'Edit',
'delete'                                  =>  'Delete',
'mode does not exist'                     =>  'That mode does not exists.',
'new topic icons'                         =>  'New topic icon',
'new topic icons info'                    =>  'The next icons are not yet added to the database.',
...
'guests can add icon'                     =>  'Guests can add icon',
'yes'                                     =>  'Yes',
'no'                                      =>  'No',
